...
import 'package:trancentum_web_app/screens/dashboard/components/progress_line.dart';
import 'package:trancentum_web_app/screens/expeditions_by_status/expeditions_by_status_screen.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (!((_size.width > 840) && (_size.width < 910)))
                  Text(
